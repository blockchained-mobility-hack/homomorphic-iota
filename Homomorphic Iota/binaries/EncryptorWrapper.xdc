...
<member name="T:seal.Encryptor" decl="false" source="c:\hackaton\seal_2.3.1\seal\seal\encryptor.h" line="15">
...
<member name="M:seal.Encryptor.#ctor(seal.SEALContext!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced,seal.PublicKey!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced)" decl="true" source="c:\hackaton\seal_2.3.1\seal\seal\encryptor.h" line="33">
...
<member name="M:seal.Encryptor.#ctor(seal.Encryptor!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced)" decl="true" source="c:\hackaton\seal_2.3.1\seal\seal\encryptor.h" line="44">
        Creates a deep copy of a given Encryptor.

        @param[in] copy The Encryptor to copy from

</member>
<member name="M:seal.Encryptor.encrypt(seal.Plaintext!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced,seal.Ciphertext*!System.Runtime.CompilerServices.IsImplicitlyDereferenced,seal.MemoryPoolHandle!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced)" decl="true" source="c:\hackaton\seal_2.3.1\seal\seal\encryptor.h" line="51">
...
<member name="M:seal.Encryptor.encrypt(seal.Plaintext!System.Runtime.CompilerServices.IsConst*!System.Runtime.CompilerServices.IsImplicitlyDereferenced,seal.Ciphertext*!System.Runtime.CompilerServices.IsImplicitlyDereferenced)" decl="false" source="c:\hackaton\seal_2.3.1\seal\seal\encryptor.h" line="73">
        Encrypts a Plaintext and stores the result in the destination parameter. Dynamic
        memory allocations in the process are allocated from the memory pool pointed to by
...
<member name="T:Microsoft.Research.SEAL.Encryptor" decl="false" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="17">
            <summary>Encrypts Plaintext objects into Ciphertext objects.</summary>

            <remarks>
            <para>
            Encrypts <see cref="T:Microsoft.Research.SEAL.Plaintext"/> objects into <see cref="T:Microsoft.Research.SEAL.Ciphertext"/> objects. 
            Constructing an Encryptor requires a <see cref="T:Microsoft.Research.SEAL.SEALContext"/> with valid encryption 
            ...
            a <see cref="T:Microsoft.Research.SEAL.MemoryPoolHandle"/> to to be used instead. This is to allow one single 
            ...
            function by giving it a thread-local <see cref="T:Microsoft.Research.SEAL.MemoryPoolHandle"/> to use. It is 
...
<member name="M:Microsoft.Research.SEAL.Encryptor.#ctor(Microsoft.Research.SEAL.SEALContext,Microsoft.Research.SEAL.PublicKey)" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="43">
<summary>Creates an Encryptor instance initialized with the specified SEALContext and public
key.</summary>

<remarks>
Creates an Encryptor instance initialized with the specified <see cref="T:Microsoft.Research.SEAL.SEALContext"/> and 
public key. Dynamically allocated member variables are allocated from the global memory pool.
</remarks>
<param name="context">The SEALContext</param>
<param name="publicKey">The public key</param>
<exception cref="T:System.ArgumentException">if encryption parameters or public key are 
not valid</exception>
<exception cref="T:System.ArgumentNullException">if context or publicKey is null</exception>

</member>
<member name="M:Microsoft.Research.SEAL.Encryptor.#ctor(Microsoft.Research.SEAL.Encryptor)" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="59">
...
<member name="M:Microsoft.Research.SEAL.Encryptor.Encrypt(Microsoft.Research.SEAL.Plaintext,Microsoft.Research.SEAL.Ciphertext)" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="67">
                <summary>ncrypts a Plaintext and stores the result in the destination parameter.</summary>

                <remarks>
                Encrypts a <see cref="T:Microsoft.Research.SEAL.Plaintext"/> and stores the result in the destination parameter. 
                ...
                <exception cref="T:System.ArgumentException">if plain is not valid for the encryption 
                parameters</exception>
                <exception cref="T:System.ArgumentNullException">if plain or destination is null</exception>

</member>
<member name="M:Microsoft.Research.SEAL.Encryptor.Encrypt(Microsoft.Research.SEAL.Plaintext,Microsoft.Research.SEAL.Ciphertext,Microsoft.Research.SEAL.MemoryPoolHandle)" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="83">
                <summary>ncrypts a Plaintext and stores the result in the destination parameter.</summary>
                ...
                parameters</exception>
                <exception cref="T:System.ArgumentException">if pool is uninitialized</exception>
                <exception cref="T:System.ArgumentNullException">if plain, destination, or pool is null</exception>

</member>
<member name="M:Microsoft.Research.SEAL.Encryptor.Dispose" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="101">
<summary>Destroys the Encryptor.</summary>

</member>
<member name="M:Microsoft.Research.SEAL.Encryptor.Finalize" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="106">
<summary>Destroys the Encryptor.</summary>

</member>
<member name="M:Microsoft.Research.SEAL.Encryptor.GetEncryptor" decl="true" source="c:\hackaton\seal_2.3.1\sealnet\sealnet\encryptorwrapper.h" line="112">
